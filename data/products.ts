...
export const products: Product[] = [
...

  {
    ...
    categoryId: 'cat-sets',
    images: ['/products/satin-rhinestone-set/01.png', '/products/satin-rhinestone-set/03.png', '/products/satin-rhinestone-set/04.png'],
    sizes: ['M', 'L', 'XL', 'XXL'],
    price: 1699000,
...

  {
    ...
    collectionId: 'col-spring-summer-2026',
    categoryId: 'cat-sets',
    images: ['/products/vest-wide-pants-set/02.png', '/products/vest-wide-pants-set/03.png', '/products/vest-wide-pants-set/04.png'],
    sizes: ['M', 'L', 'XL'],
    price: 1099000,
...

  {
    ...
    collectionId: 'col-spring-summer-2026',
    categoryId: 'cat-sets',
    images: img('cardigan-pants-set-navy', 3),
    sizes: ['M', 'L', 'XL', '2XL'],
    price: 1499000,
...

  {
    ...
    collectionId: 'col-spring-summer-2026',
    categoryId: 'cat-sets',
    images: img('top-pants-set-navy', 2),
    sizes: ['M', 'L', 'XL', '2XL'],
    price: 1499000,
...

  {
    ...
    collectionId: 'col-spring-summer-2026',
    categoryId: 'cat-sets',
    images: img('shirt-maxi-skirt-set', 5),
    sizes: ['M', 'L', 'XL'],
    price: 1099000,
...

  {
    ...
    collectionId: 'col-spring-summer-2026',
    categoryId: 'cat-sets',
    images: img('linen-two-piece-set', 3),
    sizes: ['M', 'L', 'XL'],
    price: 1099000,
...

  {
    ...
    images: img('one-shoulder-chiffon-dress', 2),
    sizes: ['S', 'M', 'L'],
    price: 1999000,
...

  {
    ...
    collectionId: 'col-spring-summer-2026',
    categoryId: 'cat-sets',
    images: img('peplum-zip-pants-indigo', 3),
    sizes: ['M', 'L', 'XL', '2XL'],
    price: 1499000,
